...
class Configurator(metaclass=SingletonMeta):
    ...
    def parse_argvars(self) -> argparse.Namespace:
        ...
        arguments = [
            ...
            {'name': ('--run-name',               '-run'), 'kwargs': {'dest': 'runName',         'type':   str,          'help': 'Name of run. This name will be added into the name of the final output file. Default: BRCA',                                                                                                                                                                   'default':               'BRCA'}},
