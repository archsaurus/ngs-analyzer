"""This module defines the VariantCoverageDTO class,
which represents coverage information for a genetic variant.

The VariantCoverageDTO class inherits from IReportDataContainer
and is implemented as a dataclass. It encapsulates details such as chromosome,
start position, reference and alternate alleles, as well as their respective
