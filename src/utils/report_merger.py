"""
    ...
    Description:
        The script takes as input a directory containing per-sample \
            report files in Excel format.
        It reads all '.xlsx' files from the specified output directory, \
            concatenates their data into one combined DataFrame, \
            and saves the result as 'report.xlsx' \
                in the same output directory.

    Arguments:
        --input / -i : \
            Path to the directory containing per-sample reports.
        --output / -o: \
            Directory for the output consolidated report.
