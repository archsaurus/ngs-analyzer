...
from ngs_analyzer.core.table_manager.csv_table_manager import CsvTableManager
from ngs_analyzer.core.table_manager.excel_table_manager import \
    ExcelTableManager
from ngs_analyzer.core.table_manager.i_table_manager import ITableManager
from ngs_analyzer.core.table_manager.xml_table_manager import XmlTableManager
...
class TableManagerFactory:
    ...
    def create_manager(format_type: str, logger=None) -> ITableManager:
        ...
        match format_type:
            case 'xml':
                return XmlTableManager(logger=logger)
            case 'xls' | 'xlsx':
                return ExcelTableManager(logger=logger)
            case 'csv' | 'tsv':
