...
from ngs_analyzer.core.base.system.platform_utils import get_platform
from ngs_analyzer.core.base.system.system_calls import execute, touch
    ...
    def generate_mpileup(
        ...
        try:
            for region, out_name in sample.target_regions:
                ...
                try:
                    self.depth_filter(filepath=out_path, depth=2)
