...
from ngs_analyzer.core.data_processing.analyzer.i_variant_caller import \
    IVariantCaller
from ngs_analyzer.core.data_processing.analyzer.variant_caller import (
    FreebayesVariantCaller, PiscesVariantCaller, UnifiedGenotyperVariantCaller)
