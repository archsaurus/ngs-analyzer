...
def parse_args() -> argparse.Namespace:
    """Parse command-line arguments for input and output paths, and patterns.
...
def merge_fastq(
    ...
    """Merge R1 and R2 FASTQ files per sample based on provided patterns."""
